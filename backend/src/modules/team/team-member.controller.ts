...
export class TeamMemberController {
    ...
    @ApiSwagger({ resourceName: 'Team Members', operation: 'getAll', isArray: true, requiresAuth: false, withPagination: true })
    ...
    @Public()
    @HttpCode(HttpStatus.OK)
    @ApiSwagger({ resourceName: 'Team Member', operation: 'getOne', requiresAuth: false })
    async findOne(@Param('id') id: string): Promise<SuccessResponseDto<TeamMember>> {
