...
import { FolderOpen, Plus, Search, Trash2, Edit, Star, ChevronLeft, ChevronRight, ExternalLink, Github, FolderGit2 } from "lucide-react";
    ...
    <div className="space-y-6 animate-fade-in">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1 text-sm">Manage your portfolio projects and case studies</p>
        </div>
