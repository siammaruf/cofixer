  ...
  return (
    <div>
      <div className="flex items-center gap-2 mb-6">
        <Link to="/admin/services" className="text-[#A93E17] hover:underline">← Back</Link>
      ...
      <form onSubmit={handleSubmit} className="max-w-xl space-y-4">
        ...
        <div>
          <label className="block text-sm font-medium mb-1 text-white">Short Description</label>
