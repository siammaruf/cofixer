...
export const protectedRoutes = [
  ...
  route("services/edit/:id", "pages/dashboard/services/edit/index.tsx"),
  route("projects", "pages/dashboard/projects/index.tsx"),
  route("projects/create", "pages/dashboard/projects/create/index.tsx"),
  route("projects/edit/:id", "pages/dashboard/projects/edit/index.tsx"),
  route("blog", "pages/dashboard/blog/index.tsx"),
  route("blog/create", "pages/dashboard/blog/create/index.tsx"),
  route("blog/edit/:id", "pages/dashboard/blog/edit/index.tsx"),
  route("blog/categories", "pages/dashboard/blog/categories/index.tsx"),
  route("blog/categories/create", "pages/dashboard/blog/categories/create/index.tsx"),
  route("blog/categories/edit/:id", "pages/dashboard/blog/categories/edit/index.tsx"),
