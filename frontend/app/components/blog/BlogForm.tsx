        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
            ...
            <div className="space-y-5">
              <Card className="bg-card border-border">
                <CardHeader className="pb-3">
                  <CardTitle className="text-sm font-semibold text-black">Publish</CardTitle>
                </CardHeader>
                <CardContent>
                  <PublishPanel
                    form={form}
              ...
              <Card className="bg-card border-border">
                <CardHeader className="pb-3">
                  <CardTitle className="text-sm font-semibold text-black">Categories</CardTitle>
                </CardHeader>
                <CardContent>
                  <FormField
                    control={form.control}
              ...
              <Card className="bg-card border-border">
                <CardHeader className="pb-3">
                  <CardTitle className="text-sm font-semibold text-black">Featured Image</CardTitle>
                </CardHeader>
                <CardContent>
                  <FormField
                    control={form.control}
              ...
              <Card className="bg-card border-border">
                <CardHeader className="pb-3">
                  <CardTitle className="text-sm font-semibold text-black">Tags</CardTitle>
                </CardHeader>
                <CardContent>
                  <FormField
                    control={form.control}
              ...
              <Card className="bg-card border-border">
                <CardHeader className="pb-3">
                  <CardTitle className="text-sm font-semibold text-black">SEO</CardTitle>
                </CardHeader>
                <CardContent>
                  <SeoPanel form={form} />
                </CardContent>
              ...
              <Card className="bg-card border-border">
                <CardHeader className="pb-3">
                  <CardTitle className="text-sm font-semibold text-black">Author</CardTitle>
                </CardHeader>
                <CardContent>
                  <FormField
                    control={form.control}
