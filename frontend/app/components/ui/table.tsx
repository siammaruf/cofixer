...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn("[&_tr]:border-b [&_tr]:border-border/60 bg-muted/40", className)} {...props} />
))
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-border/60 transition-colors duration-150 hover:bg-muted/30 data-[state=selected]:bg-muted/50",
      className
    )}
    {...props}
  />
