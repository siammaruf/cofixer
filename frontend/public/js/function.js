(function ($) {
	...
	/* Preloader Effect - handled by React to avoid hydration mismatch */
	...
	/* Slick Menu JS - handled by React Header component to avoid hydration mismatch */
	...
	try {
		if ($('.hero-company-slider').length && typeof Swiper !== 'undefined') {
	...
	} catch (e) { console.warn('Hero slider init failed:', e); }
	...
	} catch (e) { console.warn('Testimonial slider init failed:', e); }
	...
	} catch (e) { console.warn('Image reveal init failed:', e); }

	/* Text Effect Animation Start */
	try {
		if($('.text-effect').length && typeof gsap !== 'undefined' && typeof SplitText !== 'undefined') {
	...
	} catch (e) { console.warn('Text effect init failed:', e); }
	...
	} catch (e) { console.warn('WOW init failed:', e); }
